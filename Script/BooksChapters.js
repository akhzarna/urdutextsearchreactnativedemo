...
// }
  ...
  componentDidMount() {
    ...
    if (testVar == null) {
      ...
      Alert.alert("no no it's not possoble");
    }else{
    // Test Akhzar Nazir
    this.setState({
  ...
  actionButtonLoadBook(){
    ...
    RNFS.readFile(path1)
        ...
        Constants.ChapterArray=mainArray;
        Constants.isChaptersLoaded=true;
  ...
  var tempArray=[];
      ...
      //   console.log("1 inddexx"+this.state.bookArray[0].data[0].mainheading);
       ...
       if(this.state.bookArray[i].data[j].data !== this.state.bookArray[i].data[j+1].data)
                                  ...
                                  // if(j==0){
              //   tempArray.push(this.state.bookArray[i].data[j].mainheading);
              //   console.log("when 0"+this.state.bookArray[i].data[j].mainheading.length);
              //   } else{
    ...
    //     for( var j=0; j<10; j++) {
    //       if(j==0){
    //       tempArray2.push(this.state.bookArray[i].data[j].subheading);
    //       } else
    //     if(this.state.bookArray[i].data[j].mainheading = this.state.bookArray[i].data[j+1].mainheading){
    ...
    //     for( var j=0; j<10; j++) {
    //       if(j==0){
    //       tempArray3.push(this.state.bookArray[i].data[j].mainheading);
    //       } else
...
wordSelected(index){
  ...
  for (var i = 0; i < bookArray.length; i++) {
   // var mainHeading=bookArray[i].mainheading;
   // var subHeading=bookArray[i].subheading;
    var subbestheading=bookArray[i].mainheading.trim();
