  ...
  rowSelected(item,section){
    ...
    this.props.navigation.navigate('ReadingComponentFromBooks',{
      sectionArray:this.state.searchedData[section.key].data,
    ...
    render(){
      ...
      return(
          ...
          <View style={{marginTop:30,flexDirection:'row'}}>
                ...
                <View style={{flex:1,marginLeft:10,marginRight:10}}>
                {
                  this.state.showSearchField?(
                    ...
                    }}>{this.props.navigation.state.params.finalArray[0].chapter_name}</Text>
                  )
                }
                </View>
        ...
        renderItem={({item,section}) => <TouchableOpacity onPress={()=>this.rowSelected(item,section)}>
                      ...
                      <View style={{flex:8}}>
                      <Text numberOfLines={1} style={styles.textStyle}> {item.prescription_name}</Text>
                      </View>
                      </View>
