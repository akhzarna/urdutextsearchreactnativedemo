...
class ReadingScreen extends Component{
  ...
  constructor(props){
    ...
    var mainHeading = this.props.navigation.state.params.sectionArray[i].data.mainheading;
    var subHeading = this.props.navigation.state.params.sectionArray[i].data.subheading;
    var subbestHeading = this.props.navigation.state.params.sectionArray[i].data.subbestheading;
    var bookTitle = this.props.navigation.state.params.sectionArray[0].title;
    ...
    this.state={
      ...
      data:afterHeading,
      orignalData:this.props.navigation.state.params.sectionArray[0].data.data,
      indexOfBookMark:-1,
      headingWords:headingWords,
      bookTitle:bookTitle,
    }

    console.log('test Array Data is = ',this.props.navigation.state.params.sectionArray[0].data.subbestheading);
    this.state.newArray.push(this.props.navigation.state.params.sectionArray[0].data.subbestheading);
    this.state.newArray.push(this.props.navigation.state.params.sectionArray[0].data.subbestheading);
...
seperateHeadingWord(data){
  ...
  render(route){
    ...
    let shareOptions = {
         title: "کتاب الرویا",
         message:this.props.navigation.state.params.sectionArray[0].data.data,
    ...
    return(
      ...
      <FlatList
          ...
          initialScrollIndex={this.props.navigation.state.params.selectedRow}
