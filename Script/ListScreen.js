...
var crossIcon=require('./Icons/Delete.png');
...
class ListScreen extends Component{
      ...
      constructor(props){
        ...
        this.state={
          ...
          visible: false,
          bookData:[],txtSearch:'',searchBol: true,
          DataSource:[],
          DataShow:[],
          shareData:'',
          show:'',
...
actButtonSearch(){
    ...
    console.log("dta in test array",this.state.testArray[0]);
}
...
actionButtonSearch(){
 ...
 // for (var x = 0; x < this.state.testArray.length; x++) {
 //   console.log("test array length",this.state.testArray.length);
  //var bookArray=this.state.testArray[x];
  var searchedArray=[];
  var counter = 0;
  var flag = 0;
 // console.log("datatatata",bookArray[0]);
  // Testing Akhzar Nazir
  for (var i = 0; i < this.state.testArray.length; i++) {
    var mainHeading=this.state.testArray[i].mainheading;
    var subHeading=this.state.testArray[i].subheading;
        ...
        <ImageBackground resizeMode={'stretch'} style={{flex:1,}} source={headerImage}>
          <View style={{marginTop:30,flexDirection:'row'}}>
                ...
                <View style={{flex:1,marginLeft:10,marginRight:10}}>
                {
                  ...
                  <Image style={{width:30,height:30}} source={crossIcon}/>
                </TouchableOpacity>
                ...
                <TouchableOpacity onPress={()=>this.backFunction()} style={{marginRight:10}}>
