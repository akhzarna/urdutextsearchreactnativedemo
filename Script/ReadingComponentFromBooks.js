...
class ReadingComponentFromBooks extends Component{
  ...
  constructor(props){
    ...
    this.state={
      ...
      data:afterHeading,
      orignalData:this.props.navigation.state.params.sectionArray[0].prescription_detail,
      indexOfBookMark:-1,
...
seperateHeadingWord(data){
  ...
  shareFunction(item){
    ...
    title: "مطب سلیمانی",
    message:"مطب سلیمانی" + '\n' +
    this.props.navigation.state.params.sectionArray[item.key].prescription_detail
    + "ادارہ سلیمانی",
  ...
  render(route){
    ...
    let shareOptions = {
         title: "مطب سلیمانی",
         message:this.props.navigation.state.params.sectionArray[0].prescription_detail,
         subject: "Share Link" //  for email
       };
